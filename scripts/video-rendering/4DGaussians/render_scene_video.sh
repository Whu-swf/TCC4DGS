...
CONFIG_PATH="${CONFIG_PATH:-${SCRIPT_DIR}/arguments/dynerf/cook_spinach.py}"
...
for scene_name in "${SCENE_NAMES[@]}"; do
  ...
  model_path="${DATA_ROOT}/4DGaussians/${scene_name}"
  output_path="${DATA_ROOT}/videos/4DGaussians_${scene_name}.mp4"
