...
for scene_name in "${SCENE_NAMES[@]}"; do
  ...
  model_path="${DATA_ROOT}/STGS_Ours_${scene_name}"
  config_path="${SCRIPT_DIR}/configs/n3d_lite/${scene_name}.json"
  output_path="${DATA_ROOT}/videos/SpacetimeGaussians_${scene_name}.mp4"
